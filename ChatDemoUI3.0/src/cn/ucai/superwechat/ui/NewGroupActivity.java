...
public class NewGroupActivity extends BaseActivity {
    static final String TAG = "NewGroupActivity";
    ...
    private void initView() {
        ...
        mtvRightText.setText(getString(R.string.button_save));
    }
    ...
    OkHttpUtils.OnCompleteListener<String> listener = new OkHttpUtils.OnCompleteListener<String>() {
        ...
        public void onSuccess(String s) {
            if (s != null) {
                Result result = ResultUtils.getListResultFromJson(s, I.Group.class);
    ...
    @OnClick({R.id.iv_Back, R.id.tv_rightText, R.id.layout_avatar, R.id.cb_public, R.id.cb_member_inviter})
